...
=== NPC_EXTRA_DAMAGE ===
Greetings, warriors! I can offer you a powerful combat enhancement that will permanently increase your melee damage by {damage_bonus}%.  #speaker:id::npc, name::KAIROS, anim::Talk
But it will cost {cost} coins per adventurer. #speaker:id::npc, name::KAIROS, anim::Talk
 -> CHECK_DAMAGE_ELIGIBILITY

=== SINGLEPLAYER_NPC_EXTRA_DAMAGE ===
Greetings, warrior! I can offer you a powerful combat enhancement that will permanently increase your melee damage by {damage_bonus}%.  #speaker:id::npc, name::KAIROS, anim::Talk
...
- else: 
    {p1_has_enough && not p2_has_enough:
        {Player1_name}, you have enough coins, but {Player2_name} doesn’t. #speaker:id::npc, name::KAIROS, anim::Talk
        -> OFFER_P1_DAMAGE_ONLY
    - else:
        {not p1_has_enough && p2_has_enough:
            {Player2_name}, you have enough coins, but {Player1_name} doesn’t. #speaker:id::npc, name::KAIROS, anim::Talk
...
=== OFFER_BOTH_DAMAGE ===
Would you both like to spend {cost} coins each to gain {damage_bonus}% melee damage? #speaker:id::npc, name::KAIROS, anim::Talk
+ [Yes, enhance us both]
    ~ grant_damage(Player1_name, cost, damage_bonus)
...
=== OFFER_P1_DAMAGE_ONLY ===
{Player1_name}, would you like to spend {cost} coins to gain {damage_bonus}% melee damage? #speaker:id::npc, name::KAIROS, anim::Talk
+ [Yes, give me the enhancement]
    ~ grant_damage(Player1_name, cost, damage_bonus)
    ({Player1_name} feels their strikes grow sharper!) #speaker:id::npc, name::KAIROS, anim::Talk
    -> END
+ [No, I’ll pass]
...
+ [Yes, give me the enhancement]
    ~ grant_damage(Player2_name, cost, damage_bonus)
    ({Player2_name} feels their strikes grow sharper!) #speaker:id::npc, name::KAIROS, anim::Talk
    -> END
+ [No, I’ll pass]
    Very well, maybe another time. #speaker:id::npc, name::KAIROS, anim::Talk
    -> END
