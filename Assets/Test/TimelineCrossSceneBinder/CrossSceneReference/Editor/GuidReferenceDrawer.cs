...
public class GuidReferenceDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        currentGO = GuidLookupTable.ResolveGuid(currentGuid);
        ObjectGuid currentObjectGuid = currentGO != null ? currentGO.GetComponent<ObjectGuid>() : null;

        ObjectGuid component = null;

        if (currentGuid != System.Guid.Empty && currentObjectGuid == null)
        {
            ...
            component = EditorGUI.ObjectField(guidCompPosition, currentObjectGuid, typeof(ObjectGuid), true) as ObjectGuid;

        if (currentObjectGuid != null && component == null)
            ClearPreviousGuid();
        ...
        if (component != null)
        {
            ...
            if (component != currentObjectGuid)
            {
