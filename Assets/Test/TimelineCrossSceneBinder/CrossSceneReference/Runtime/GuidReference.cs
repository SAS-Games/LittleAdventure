...
public class GuidReference : ISerializationCallbackReceiver
{
    ...
    public SceneAsset CachedScene => cachedScene;
#endif
    ...
    public GameObject gameObject
    {
        get
        {
            ...
            _cachedReference = GuidLookupTable.ResolveGuid(_guid, _addDelegate, _removeDelegate);
            _isCacheSet = true;
            return _cachedReference;
        }
    ...
    public GuidReference(ObjectGuid target)
    {
